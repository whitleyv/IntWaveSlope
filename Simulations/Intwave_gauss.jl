...
# dye parameters
const dye_height15 = 15                               # height of initial dye
const dye_height05 = 5                               # height of initial dye
...
model = NonhydrostaticModel(; tracers = (:b, :Cg15, :Cg05,) , kwargs_model...)
...
# gaussian 
@inline c₀1(x, y, z) = above_slope(y, z) * dye_gauss(y, z, dye_height15)
# tanh IC
@inline c₀2(x, y, z) =  above_slope(y, z) * dye_gauss(y, z, dye_height05)

set!(model, u=0, v=0, w=0, b=b₀, Cg15=c₀1, Cg05=c₀2,)

###########-------- SIMULATION SET UP ---------------#############
@info "Simultion set up..."

name_prefix = "IntWave_GaussSurvey_" * setname
