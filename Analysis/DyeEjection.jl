...
arrows!(axc[1], [250/pm.Tanα], [-250], [0], [δ], arrowsize = 10, linewidth = 4,  
    arrowcolor = :red, linecolor = :red)
text!(axc[1], [250/pm.Tanα - 60], [-250 + δ/2], text="δ", align = (:left, :center), 
    color = :red, font = :bold, fontsize = 25)
...
savename = "paper_dyeejections2_" * setname
