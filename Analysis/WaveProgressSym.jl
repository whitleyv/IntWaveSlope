...
interest_idx1 = [round(Int,(pm.Tσ*2.0)/600), round(Int,(pm.Tσ*2.2)/600), round(Int,(pm.Tσ*2.4)/600)]
interest_idx2 = [round(Int,(pm.Tσ*2.5)/600), round(Int,(pm.Tσ*2.7)/600), round(Int,(pm.Tσ*2.9)/600)]
...
#title = @lift "Tσ = "*string(round(b_timeseries.times[j]/pm.Tσ, digits=2))
# label eachs et
#title1 = "First Wave"
#Label(ga[1, 1:3, Top()], title1,
# valign = :bottom, font = :bold, padding = (0, 0, 5, 0))
#
# title2 = "Second Wave"
#Label(gb[1, 1:3, Top()], title2,
# valign = :bottom, font = :bold, padding = (0, 0, 5, 0))
...
cb2 = Colorbar(gcb2[1,1], hmc, ticks = (-4:1:-1, ["10⁻⁴", "10⁻³", "10⁻²", "10⁻¹"] ), 
        size = 35, label = "Trcaer Concentration")
...
savename = "waveseries_sym_" * setname
