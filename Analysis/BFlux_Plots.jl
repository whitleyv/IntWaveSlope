...
ga = f[1, 1:8] = GridLayout()
gb = f[2, 1:8] = GridLayout()
gc = f[3, 1:8] = GridLayout()
gbd = f[4, 1:8] = GridLayout()
gcd = f[5, 1:8] = GridLayout()
#ge = f[6, 1:8] = GridLayout()
...
ydx1 = 271:280
ydx2 = 180:189
vi1 = mean(v_Phavg_xavg[ydx1,zdx1 ,:], dims = (1,2))[1,1,:]
vi2 = mean(v_Phavg_xavg[ydx2,zdx2, :], dims = (1,2))[1,1,:]
gradbfluxi1 = mean(∇WpertPhavg_xavg[ydx1,zdx1, :], dims = (1,2))[1,1,:]
gradbfluxi2 = mean(∇WpertPhavg_xavg[ydx2,zdx2, :], dims = (1,2))[1,1,:]
bi1 = mean(b_Phavg_xavg[ydx1,zdx1, :], dims = (1,2))[1,1,:]
bi2 = mean(b_Phavg_xavg[ydx2,zdx2, :], dims = (1,2))[1,1,:]

f = Figure(resolution = (800, 800), fontsize=26)
g = f[1, 1] = GridLayout()
ax1 = Axis(g[1, 1], ylabel = "v", xlabel = "Tσ") 
ax2 = Axis(g[2, 1], ylabel = "∇⋅<u⃗'b'>", xlabel = "Tσ") 
ax3 = Axis(g[3, 1], ylabel = "b", xlabel = "Tσ") 
hidexdecorations!(ax2)
hidexdecorations!(ax1)

lines!(ax1, phase_times, vi1, color=:dodgerblue2, lw = 5,label = "Bot")
lines!(ax1, phase_times, vi2, color=:firebrick2, lw = 5, label ="Mid")
axislegend(ax1)

lines!(ax2, phase_times, gradbfluxi1, color=:dodgerblue2, lw = 5,)
lines!(ax2, phase_times, gradbfluxi2, color=:firebrick2, lw = 5 )

lines!(ax3, phase_times, bi1, color=:dodgerblue2, lw = 5)
lines!(ax3, phase_times, bi2, color=:firebrick2, lw = 5,)


savename = "BfluxLineplots_Phavg_" * sn
apath  = "Plots/"
